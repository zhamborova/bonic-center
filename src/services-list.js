...
const service_list = {
  one: {
      ...
      laser_gynecology: {
          ...
          additional: "Ознакомиться с процедурой можно здесь \n https://www.youtube.com/watch?v=su6XrRclmnk",
          pictures: [[before, after], [before, after]],
          recovery: null,
      ...
      botox_injection: {
          ...
          additional: "Как действует токсин ботулина?\n" +
              "— Механизм действия заключается в блокировке двигательного импульса с нерва на мышцу. В результате мышца расслабляется. При этом даже если вы захотите по привычке наморщить лоб или нахмуриться, у вас  не получится — мышца останется расслабленной, а кожа гладкой.\n" +
              "От Ботокса, Диспорта могут отмереть мышцы?\n" +
              "— Мышечные волокна не разрушаются, мышца просто «спит», так как прерывается нервно-мышечная передача к мимической мышце. Эта передача восстанавливается через некоторое время.\n" +
              "Когда становится заметен эффект после процедуры и долго ли он сохраняется?\n" +
              "— Препарат начинает действовать примерно через трое суток и достигает максимума через две недели. Мелкие и глубокие морщины разглаживаются, а поверхность кожи становится ровной. Эффект сохраняется от четырех до шести месяцев, в зависимости от обменных процессов, состояния кожи. Часто после нескольких процедур исчезает вредная привычка хмурить лоб, и проблема решается сама собой. Для достижения стойкого и длительного эффекта рекомендуется введение препаратов 2 раза в течение года.\n" +
              "\n" +
              "\n" +
              "Поможет ли Ботокс, Диспорт избавиться от уже сформировавшихся глубоких морщин?\n" +
              "— Применение данных препаратов можно сочетать с коррекцией глубоких морщин гелями на основе гиалуроновой кислоты (Restylane, Surgiderm).\n" +
              "\n" +
              "Есть ли побочные эффекты?\n" +
              "— Небольшие  гематомы, отеки вокруг глаз. В области лба может наблюдаться парестезия — ощущение инородного тела, зуд. Это нормально, так как является особенностью работы нервной системы.\n" +
              "Есть и приятный побочный эффект — в некоторых случаях может проходить мигрень, если она была вызвана парадоксальной работой мышц. Недаром изначально препараты на основе токсина ботулина применялись для лечения мигреней и заболеваний мышц.\n" +
              "Применяется ли Ботокс, Диспорт для мужчин?\n" +
              "— Да, эти препараты  применяются для мужчин, как с целью коррекции морщин, так и для решения распространенной проблемы гипергидроза — повышенного потоотделения в области подмышек, на ладонях.\n" +
              "В последнем случае делаются множественные подкожные инъекции. В результате снижается активность потовых желез (блокируются нервные окончания, которые подходят к потовой железе). При этом потоотделение не «отключается» полностью, терморегуляция организма сохраняется.\n",
          pictures: [[before, after], [before, after]],
          recovery: null,
          course: "Разовая процедура",
      ...
      growths_removal: {
          ...
          description: "Компания Fotona (Словения) разработала уникальную, эффективную технологию – FT лазерное удаление новообразований.\n" +
              "\n" +
              "Процедура FT лазерного удаления новообразований позволяет бережно удалить образования абсолютно любой сложности и размера. Преимущество данного метода заключается в безопасности применения технологии FT.\n" +
              "\n" +
      ...
      acne_removal: {
          ...
          additional: "Во время процедуры FT лазерного лечения акне лазерный луч глубоко проникает в кожу и убивает болезнетворные бактерии, которые вызывают воспаление. Лазер, точно воздействуя на каждый очаг воспаления кратковременными импульсами, доводит ткани до критической температуры, при которой бактерии гибнут. Процесс происходит абсолютно безболезненно. После процедуры постепенно уходит воспаление, исчезают отеки и покраснения.\n" +
              "\n" +
              "Кроме того, процедуры лечения акне лазером позволяют восстанавливать обменные процессы в коже, активировать синтез новых коллагеновых волокон и отшелушивать старые ороговевшие клетки. Кожа полностью очищается от прыщей и выглядит гладкой и привлекательной.\n" +
              "\n" +
...
"Гемангиомы – родимые пятна, состоящие из паукообразных расширенных кровеносных сосудов кожи"],
          description: "FT лазерное удаление сосудов сочетает в себе наиболее важные характеристики, которые позволяют эффективно и безболезненно удалить сосудистые звездочки любой сложности и исключает ожоги и болевые ощущения.\n" +
              "\n" +
          ...
          additional: "Особенность процедуры FT лазерного удаления сосудов заключается в воздействии лазерного луча, в результате которого происходит «склеивание» стенок сосуда. Мелкие сосуды удаляются бесследно, крупные сосудистые пятна, гемангиомы, бледнеют и значительно уменьшаются в размерах. Лазерное воздействие оказывается только на стенки капилляров, окружающие ткани и здоровые сосуды не травмируются.\n" +
              "\n" +
              "Количество процедур лазерного удаления сосудистых звездочек зависит от диаметра сосуда. Если сосуд небольшого диаметра (1-1,5 мм), то он может исчезнуть после 1-2 процедур. При работе с более крупными сосудами может потребоваться до 4-5 визитов к врачу.\n" +
              "\n" +
      ...
      laser_epilation: {
          ...
          description: "Лазерная эпиляция – это самый эффективный и щадящий для кожи способ удаления волос навсегда как для женщин так и для мужчин. Благодаря световой энергии лазера, которая воздействуя на пигмент волоса и на сосуд, который его питает, трансформируется в тепловую энергию и неотвратимо разрушает волосяной фолликул. Таким образом, мы можем провести удаление волос лазером на всех зонах лица и тела.\n" +
              ...
              "\n" +
              "Для полного лазерного удаления волос, Вам понадобится несколько процедур лазерной эпиляции с перерывами между процедурами в 1-1,5 месяца в начале лечения.\n" +
              "\n" +
              "С нарастанием количества процедур, перерывы между визитами к доктору будут увеличиваться. И в очередной раз, записавшись на процедурулазерной эпиляции, Вы вдруг обнаружите, что идти к доктору, просто не с чем – волосы к ожидаемому времени даже не проклюнулись…\n" +
              "\n" +
          ...
          additional: "Важно понимать цикл роста волос и то, как этот цикл изменяется на различных анатомических участках. Ниже описаны три стадии роста волос:\n" +
              "\n" +
              "Анаген: стадия синтеза волоса. Стадия активного роста, во время которой волосяная луковица остается неповрежденной. Волос растет как вверх, так и вниз. На ранней стадии анагена луковица находится ближе всего к поверхности кожи, таким образом обеспечивая наиболее эффективную обработку. Длительность стадии измеряется в месяцах/годах.\n" +
              "Катаген: краткосрочная промежуточная стадия, измеряется неделями, является переходной от анагена к телогену. Во время этой стадии нижняя треть волосяного фолликула поглощается телом.\n" +
              "Телоген: период покоя. Волосяной луковицы уже нет. Именно во время этой стадии волос выпадает или выталкивается фолликулом нового волоса в стадии анагена. Длительность стадии измеряется в месяцах/годах.\n" +
              "Только во время стадии роста или анагена волос реагирует на лазерное излучение. Для достижения долгосрочных результатов по удалению волос, лазерный свет должен проникнуть в глубину волосяного фолликула, находящегося в стадии анагена.\n"+
              "Что такое лазерная эпиляция?\n" +
              "Это устранение волосяных фолликул без повреждения кожи. Благодаря воздействию лазера на волосяной фолликул обработанный волос разрушается, выпадает и больше не вырастает  никогда. Лазерная эпиляция —методика, позволяющая  решить проблему  нежелательных волос  на лице и теле  надолго или навсегда. В мире эта технология существует и успешно применяется на практике более 20 лет. \n" +
              "\n" +
              "Правда ли что лазерная эпиляция может нанести вред здоровью, лазер плохо влияет на внутренние органы?\n" +
              "Глубина проникновения лазерного луча при эпиляции составляет всего 1−4 мм, он достигает только волосяных фолликулов, затем полностью рассеивается и не проникает глубже кожи. При воздействии лазера разрушается только волосяная луковица. Лазерный луч скользит по поверхности кожи, не повреждая ее. Единственное, что может возникнуть после процедуры — покраснение, ктоторое является показателем правильного выполнения процедуры и через несколько часов проходит бесследно.\n" +
              "Может ли лазерная  эпиляция может быть причиной образования рубцов и врастания волос?\n" +
              "Лазерная эпиляция не сопровождается  нарушением целостности кожных покровов, поэтому  нет и процессов рубцевания. Врастание волос, очень часто сопровождает восковую депиляцию и не встречается при лазерной эпиляции. Более того лазерный метод рекомендуют в качестве метода устранения подобных явлений.\n" +
              "Насколько дорого стоит лазерная эпиляция?\n" +
              "Давайте посчитаем. Сколько обычно женщина тратит в год на покупку средств для депиляции — станки, кремы, пенки и т. д. А за 10 лет? А теперь посчитайте стоимость курса лазерной эпиляции — 6-8 сеансов с интервалом 2−3 месяца, и все. Сравните эти цифры.\n" +
              "Лазерная эпиляция — это больно?\n" +
              "Невозможно утверждать однозначно. Все зависит от индивидуального порога болевой чувствительности. Ощущения от лазерной эпиляции скорее можно назвать неприятными, они сравнимы со щелчками по коже и обычно переносятся хорошо, при этом используется специализированная система охлаждения.\n" +
              "Можно удалить волосы за один раз и навсегда?\n" +
              "К сожалению, невозможно за один раз получить требуемый эффект. Лазерный свет поглощается только «зрелыми» волосяными фолликулами, а таких на нашем теле от 5 до 20%. Поэтому и требуется курс из 6-8 процедур. Разрушенные фолликулы уже в дальнейшем не растут. Необходимо также учитывать такие факторы как эндокринные нарушения, гормональный дисбаланс.\n" +
              "Можно ли проводить лазерную эпиляцию на загорелой коже?\n" +
              "При загаре в коже образуется меланин, который служит мишенью для лазера, и риск получения ожога возрастает. Однако в нашей клинике  есть оборудование, позволяющее при адекватном подборе программ обеспечить необходимый эффект без повреждения загорелой кожи.\n" +
              "Способствует ли лазер появлению новообразований кожи?\n" +
      ...
      laser_rejuvination: {
          ...
          "Тусклый цвет лица",
          "Фотостарение"],
          description: "Глубокое лазерное омоложение – курсовая процедура, состоящая из 4-6 сеансов, которая позволяет получить длительный эффект омоложения кожи (до 5 лет) и требует минимального периода восстановления.\n" +
              "\n" +
      ...
      laser_piling: {
          ...
          "«Гусиные лапки»",
          "Тусклый цвет лица"],
          description: "FT лазерный пилинг – эффективный метод лазерного воздействия, направленный на обновление и выравнивание кожи. FT лазерный пилинг проводится с целью разглаживания рельефа кожи, омоложения, улучшения ее оптических и защитных свойств, устранения и сглаживания эстетических дефектов.\n" +
              "\n" +
          ...
          additional: "FT холодный лазерный пилинг\n" +
              "Описание процедуры лазерного пилинга:\n" +
              "Основная цель холодного лазерного пилинга – мгновенное выравнивание поверхности кожи и достижение эффекта «бархатной кожи».\n" +
              "\n" +
              "Суть процедуры холодного лазерного пилинга:\n" +
              "Холодный лазерный пилинг заключается в воздействии лазерного луча на кожу, который послойно испаряет ее верхние слои. После процедуры лазерного пилинга исчезают мелкие морщинки, кожа разглаживается, становиться ровной, матовой и бархатистой, значительно улучшаются ее оптические свойства.\n" +
              "\n" +
              "Период восстановления после лазерного пилинга:\n" +
              "составляет 3- 5 дней, сопровождается шелушением кожи.\n" +
              "\n" +
              "Курс лазерного пилинга:\n" +
              "3 процедуры.\n" +
              "\n" +
              "Эффект после холодного FT лазерного пилинга:\n" +
              "мгновенный эффект, сохраняется до полугода.\n" +
              "\n" +
              "FT горячий лазерный пилинг\n" +
              "Описание процедуры лазерного пилинга:\n" +
              "FT горячий лазерный пилинг также направлен на выравнивание рельефа, но, в отличие от холодного лазерного пилинга, данная процедура обеспечивает еще и заметную подтяжку кожи. Результат горячего лазерного пилинга лица не проявляется моментально, а нарастает в течение 2-3 месяцев. В конечном итоге эффект от процедуры горячего лазерного пилинга более выражен и дольше сохраняется.\n" +
              "\n" +
              "Суть процедуры горячего FT лазерного пилинга:\n" +
              ...
              "\n" +
              "Кожа становится более ровной, упругой, бархатистой и подтянутой, а овал лица более четким, мелкие морщины исчезают, а глубокие сглаживаются. Кожа сияет, становится более здоровой и молодой.\n" +
              "\n" +
              "Период восстановления после горячего FT лазерного пилинга:\n" +
              "\n" +
              "составляет 5-7 дней, сопровождается шелушением, отеком, покраснением кожи.\n" +
              "\n" +
              "Курс процедур лазерного пилинга:\n" +
              "1-3 процедуры.\n" +
              "\n" +
              "Эффект после горячего FT лазерного пилинга:\n" +
      ...
      countur_plastic: {
          ...
          additional: "Быстрое проведение процедур. Контурная пластика с использованием препаратов на основе гиалуроновой кислоты занимает 15-30 минут. Эффект от инъекции виден сразу.\n" +
